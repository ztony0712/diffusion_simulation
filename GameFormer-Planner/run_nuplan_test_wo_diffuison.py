...
path_to_add = "/home/nuplan/LeapfrogAV/"
sys.path.append(path_to_add)

from tqdm import tqdm
# from Planner.planner import Planner
from Planner.ledplanner import Planner
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, help='path to model', default='/home/nuplan/LeapfrogAV/LED/results/led_augment/models_folder/models/model_0330.p')
